...
public static class ProjectAreaErrorCodes
{
    ...
    public const string ProjectAreaAlreadyCancelled = "PROJECT_AREA_ALREADY_CANCELLED";
    public const string ProjectAreaNotFound = "PROJECT_AREA_NOT_FOUND";
