    ...
    private static Task<int> SeedProductVersionsAsync(RawSeedExecutor executeRawAsync, CancellationToken cancellationToken)
    {
        return executeRawAsync(
            ...
            INSERT INTO product_versions (
                ...
                material, color, width, height, depth, dimension_unit, estimated_price,
                is_default, is_public, is_project_specific, status, created_at, updated_at
            )
            VALUES
                ('30000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000001', null, 'SOFA-LUX-001-A', 'Luxe Modular Sofa - Linen', 'STANDARD'::product_version_type, 'Solid wood frame, linen upholstery', 'Warm Gray', 280.00, 82.00, 95.00, 'cm', 18500000.00, true, true, false, 'ACTIVE'::product_status, now(), now()),
                ('30000000-0000-0000-0000-000000000002', '20000000-0000-0000-0000-000000000002', null, 'WARD-STD-001-A', 'Sliding Door Wardrobe - White Oak', 'STANDARD'::product_version_type, 'MDF, laminate', 'White Oak', 240.00, 260.00, 60.00, 'cm', 22500000.00, true, true, false, 'ACTIVE'::product_status, now(), now()),
                ('30000000-0000-0000-0000-000000000003', '20000000-0000-0000-0000-000000000003', null, 'KITCH-CAB-001-A', 'Modern Kitchen Cabinet - Gloss White', 'STANDARD'::product_version_type, 'Plywood, acrylic surface', 'Gloss White', 360.00, 220.00, 65.00, 'cm', 42000000.00, true, true, false, 'ACTIVE'::product_status, now(), now()),
                ('30000000-0000-0000-0000-000000000004', '20000000-0000-0000-0000-000000000004', null, 'DESK-OAK-001-A', 'Oak Work Desk - Natural', 'STANDARD'::product_version_type, 'Oak veneer, powder-coated steel', 'Natural Oak', 160.00, 75.00, 70.00, 'cm', 8900000.00, true, true, false, 'ACTIVE'::product_status, now(), now()),
                ('30000000-0000-0000-0000-000000000005', '20000000-0000-0000-0000-000000000003', '40000000-0000-0000-0000-000000000004', 'KITCH-CAB-001-CUSTOM-001', 'Premium Service Counter - Dark Walnut', 'PROJECT_SPECIFIC'::product_version_type, 'Plywood with walnut veneer', 'Dark Walnut', 380.00, 220.00, 70.00, 'cm', 52000000.00, false, false, true, 'ACTIVE'::product_status, now(), now()),
                ('30000000-0000-0000-0000-000000000006', '20000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000006', 'SOFA-LUX-001-CUSTOM-001', 'Showroom Modular Sofa - Premium Fabric', 'PROJECT_SPECIFIC'::product_version_type, 'Stain-resistant linen', 'Warm Gray', 280.00, 82.00, 95.00, 'cm', 24500000.00, false, false, true, 'ACTIVE'::product_status, now(), now())
    ...
    private static Task<int> SeedProposalItemsAsync(RawSeedExecutor executeRawAsync, CancellationToken cancellationToken)
    {
        return executeRawAsync(
            ...
            INSERT INTO proposal_items (
                ...
                product_version_id, item_name, item_type,
            ...
            VALUES
                ('52000000-0000-0000-0000-000000000001', '50000000-0000-0000-0000-000000000002', '51000000-0000-0000-0000-000000000001', 'seed-office-desk-001', '41000000-0000-0000-0000-000000000001', '30000000-0000-0000-0000-000000000004', 'Oak Work Desk Package', 'PRODUCT', 12, 160.00, 75.00, 70.00, 'Oak veneer, powder-coated steel', 'Natural Oak', false, 8900000.00, 106800000.00, 'Twelve desk package for open office.', now() - INTERVAL '4 days', now() - INTERVAL '4 days'),
                ('52000000-0000-0000-0000-000000000002', '50000000-0000-0000-0000-000000000004', '51000000-0000-0000-0000-000000000002', 'seed-cafe-counter-001', '41000000-0000-0000-0000-000000000002', '30000000-0000-0000-0000-000000000003', 'Premium Service Counter', 'PRODUCT', 1, 360.00, 220.00, 65.00, 'Plywood, acrylic surface', 'Gloss White', true, 42000000.00, 52000000.00, 'Customized counter finish for premium cafe.', now() - INTERVAL '5 days', now() - INTERVAL '2 days'),
                ('52000000-0000-0000-0000-000000000003', '50000000-0000-0000-0000-000000000006', '51000000-0000-0000-0000-000000000003', 'seed-showroom-sofa-001', '41000000-0000-0000-0000-000000000003', '30000000-0000-0000-0000-000000000001', 'Showroom Modular Sofa', 'PRODUCT', 2, 280.00, 82.00, 95.00, 'Solid wood frame, linen upholstery', 'Warm Gray', false, 18500000.00, 37000000.00, 'Reception sofa set.', now() - INTERVAL '18 days', now() - INTERVAL '18 days'),
                ('52000000-0000-0000-0000-000000000004', '50000000-0000-0000-0000-000000000005', null, null, null, '30000000-0000-0000-0000-000000000002', 'Restaurant Storage Wardrobe', 'PRODUCT', 3, 240.00, 260.00, 60.00, 'MDF, laminate', 'White Oak', false, 22500000.00, 67500000.00, 'Back-office storage for restaurant.', now() - INTERVAL '12 days', now() - INTERVAL '8 days'),
                ('52000000-0000-0000-0000-000000000005', '50000000-0000-0000-0000-000000000007', null, null, null, '30000000-0000-0000-0000-000000000004', 'Delivered Office Desk Set', 'PRODUCT', 8, 160.00, 75.00, 70.00, 'Oak veneer, powder-coated steel', 'Natural Oak', false, 8900000.00, 71200000.00, 'Delivered desk set.', now() - INTERVAL '30 days', now() - INTERVAL '25 days')
    ...
    private static Task<int> SeedQuotationsAsync(RawSeedExecutor executeRawAsync, CancellationToken cancellationToken)
    {
        return executeRawAsync(
            ...
            INSERT INTO quotations (
                ...
                subtotal_amount, total_discount_amount, pre_vat_amount, vat_rate, vat_amount, total_amount, currency, status,
            ...
            VALUES
                ('60000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000004', '50000000-0000-0000-0000-000000000004', 'QTN-SEED-0001', 1, 52000000.00, 0.00, 52000000.00, 0.0800, 4160000.00, 56160000.00, 'VND', 'DRAFT'::quotation_status, DATE '2026-12-31', null, 'Draft quotation for selected cafe proposal.', null, null, 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', null, null, null, now() - INTERVAL '2 days', now() - INTERVAL '2 days'),
                ('60000000-0000-0000-0000-000000000002', '40000000-0000-0000-0000-000000000003', '50000000-0000-0000-0000-000000000002', 'QTN-SEED-0002', 1, 106800000.00, 5000000.00, 101800000.00, 0.0800, 8144000.00, 109944000.00, 'VND', 'SENT'::quotation_status, DATE '2026-12-20', 'Please review the office quotation.', 'Sent to customer for office project.', null, null, 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', now() - INTERVAL '1 day', null, null, now() - INTERVAL '2 days', now() - INTERVAL '1 day'),
                ('60000000-0000-0000-0000-000000000003', '40000000-0000-0000-0000-000000000005', '50000000-0000-0000-0000-000000000005', 'QTN-SEED-0003', 1, 67500000.00, 0.00, 67500000.00, 0.0800, 5400000.00, 72900000.00, 'VND', 'ACCEPTED'::quotation_status, DATE '2026-12-15', null, 'Accepted restaurant quotation.', null, null, 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', now() - INTERVAL '8 days', now() - INTERVAL '7 days', null, now() - INTERVAL '9 days', now() - INTERVAL '7 days'),
                ('60000000-0000-0000-0000-000000000004', '40000000-0000-0000-0000-000000000006', '50000000-0000-0000-0000-000000000006', 'QTN-SEED-0004', 1, 49000000.00, 0.00, 49000000.00, 0.0800, 3920000.00, 52920000.00, 'VND', 'ACCEPTED'::quotation_status, DATE '2026-12-18', null, 'Accepted showroom quotation.', null, null, 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', now() - INTERVAL '18 days', now() - INTERVAL '17 days', null, now() - INTERVAL '19 days', now() - INTERVAL '17 days'),
                ('60000000-0000-0000-0000-000000000005', '40000000-0000-0000-0000-000000000007', '50000000-0000-0000-0000-000000000007', 'QTN-SEED-0005', 1, 71200000.00, 0.00, 71200000.00, 0.0800, 5696000.00, 76896000.00, 'VND', 'ACCEPTED'::quotation_status, DATE '2026-10-30', null, 'Accepted completed office quotation.', null, null, 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', now() - INTERVAL '28 days', now() - INTERVAL '27 days', null, now() - INTERVAL '29 days', now() - INTERVAL '27 days')
    ...
    private static Task<int> SeedQuotationItemsAsync(RawSeedExecutor executeRawAsync, CancellationToken cancellationToken)
    {
        return executeRawAsync(
            ...
            INSERT INTO quotation_items (
                quotation_item_id, quotation_id, proposal_item_id, product_version_id,
                ...
                is_customized, note, created_at, updated_at
            )
            VALUES
                ('61000000-0000-0000-0000-000000000001', '60000000-0000-0000-0000-000000000001', '52000000-0000-0000-0000-000000000002', '30000000-0000-0000-0000-000000000005', 'Modern Kitchen Cabinet', 'Premium Service Counter - Dark Walnut', 'KITCH-CAB-001-CUSTOM-001', 'Premium Service Counter', 'Cafe counter product item.', 1, 52000000.00, 52000000.00, 0.00, 52000000.00, true, 'Dark walnut customization included.', now() - INTERVAL '2 days', now() - INTERVAL '2 days'),
                ('61000000-0000-0000-0000-000000000003', '60000000-0000-0000-0000-000000000002', '52000000-0000-0000-0000-000000000001', '30000000-0000-0000-0000-000000000004', 'Oak Work Desk', 'Oak Work Desk - Natural', 'DESK-OAK-001-A', 'Oak Work Desk Package', 'Office desks quotation item.', 12, 8900000.00, 106800000.00, 5000000.00, 101800000.00, false, null, now() - INTERVAL '2 days', now() - INTERVAL '1 day'),
                ('61000000-0000-0000-0000-000000000004', '60000000-0000-0000-0000-000000000003', '52000000-0000-0000-0000-000000000004', '30000000-0000-0000-0000-000000000002', 'Sliding Door Wardrobe', 'Sliding Door Wardrobe - White Oak', 'WARD-STD-001-A', 'Restaurant Storage Wardrobe', 'Storage furniture for restaurant.', 3, 22500000.00, 67500000.00, 0.00, 67500000.00, false, null, now() - INTERVAL '9 days', now() - INTERVAL '7 days'),
                ('61000000-0000-0000-0000-000000000006', '60000000-0000-0000-0000-000000000004', '52000000-0000-0000-0000-000000000003', '30000000-0000-0000-0000-000000000006', 'Luxe Modular Sofa', 'Showroom Modular Sofa - Premium Fabric', 'SOFA-LUX-001-CUSTOM-001', 'Showroom Modular Sofa', 'Showroom reception sofa set.', 2, 24500000.00, 49000000.00, 0.00, 49000000.00, true, 'Premium fabric upgrade.', now() - INTERVAL '19 days', now() - INTERVAL '17 days'),
                ('61000000-0000-0000-0000-000000000008', '60000000-0000-0000-0000-000000000005', '52000000-0000-0000-0000-000000000005', '30000000-0000-0000-0000-000000000004', 'Oak Work Desk', 'Oak Work Desk - Natural', 'DESK-OAK-001-A', 'Delivered Office Desk Set', 'Completed office desk package.', 8, 8900000.00, 71200000.00, 0.00, 71200000.00, false, null, now() - INTERVAL '29 days', now() - INTERVAL '27 days')
    ...
    private static Task<int> SeedOrdersAsync(RawSeedExecutor executeRawAsync, CancellationToken cancellationToken)
    {
        return executeRawAsync(
            ...
            INSERT INTO orders (
                ...
                vat_rate, vat_amount, original_total_amount, item_adjustment_amount, additional_discount_amount, final_total_amount,
            ...
            VALUES
                ('70000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000005', '50000000-0000-0000-0000-000000000005', '60000000-0000-0000-0000-000000000003', 'ORD-SEED-0001', 'dddddddd-dddd-dddd-dddd-dddddddddddd', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 0.0800, 5400000.00, 72900000.00, 0.00, 0.00, 72900000.00, 21870000.00, 0.00, 72900000.00, 'DEPOSIT_PENDING'::order_status, 'Binh Thanh District, Ho Chi Minh City', 'Nguyen Cafe Owner', '0911000001', 'Deliver after site floor completion.', null, 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', now() - INTERVAL '7 days', now() - INTERVAL '7 days', now() - INTERVAL '7 days'),
                ('70000000-0000-0000-0000-000000000002', '40000000-0000-0000-0000-000000000006', '50000000-0000-0000-0000-000000000006', '60000000-0000-0000-0000-000000000004', 'ORD-SEED-0002', 'dddddddd-dddd-dddd-dddd-dddddddddddd', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 0.0800, 3920000.00, 52920000.00, 0.00, 0.00, 52920000.00, 15876000.00, 15876000.00, 37044000.00, 'DEPOSIT_PAID'::order_status, 'Tan Binh District, Ho Chi Minh City', 'Tran Fashion Owner', '0911000002', 'Coordinate delivery by display zones.', null, 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', now() - INTERVAL '17 days', now() - INTERVAL '17 days', now() - INTERVAL '1 day'),
                ('70000000-0000-0000-0000-000000000003', '40000000-0000-0000-0000-000000000007', '50000000-0000-0000-0000-000000000007', '60000000-0000-0000-0000-000000000005', 'ORD-SEED-0003', 'dddddddd-dddd-dddd-dddd-dddddddddddd', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 0.0800, 5696000.00, 76896000.00, 0.00, 0.00, 76896000.00, 23068800.00, 76896000.00, 0.00, 'IN_PRODUCTION'::order_status, 'District 5, Ho Chi Minh City', 'Le Office Manager', '0911000003', 'Completed seed order kept for history.', 'All delivered items confirmed.', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', now() - INTERVAL '27 days', now() - INTERVAL '27 days', now() - INTERVAL '1 day')
