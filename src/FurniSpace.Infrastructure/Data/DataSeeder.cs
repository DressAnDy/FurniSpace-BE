...
public static class DataSeeder
{
    ...
    private static Task<int> SeedAccountsAsync(InterpolatedSeedExecutor executeInterpolatedAsync, CancellationToken cancellationToken)
    {
        return executeInterpolatedAsync(
            ...
            VALUES
                ...
                ('a0000000-0000-0000-0000-000000000101', '44444444-4444-4444-4444-444444444444', 'customer1@furnispace.local', {SeedPasswordHash}, 'Nguyen Cafe Owner', '0911000001', 'ACTIVE'::account_status, now(), now()),
                ('a0000000-0000-0000-0000-000000000102', '44444444-4444-4444-4444-444444444444', 'customer2@furnispace.local', {SeedPasswordHash}, 'Tran Fashion Owner', '0911000002', 'ACTIVE'::account_status, now(), now()),
                ('a0000000-0000-0000-0000-000000000103', '44444444-4444-4444-4444-444444444444', 'customer3@furnispace.local', {SeedPasswordHash}, 'Le Office Manager', '0911000003', 'ACTIVE'::account_status, now(), now()),
                ('b0000000-0000-0000-0000-000000000101', '22222222-2222-2222-2222-222222222222', 'sales1@furnispace.local', {SeedPasswordHash}, 'Sarah Sales One', '0922000001', 'ACTIVE'::account_status, now(), now()),
                ('b0000000-0000-0000-0000-000000000102', '22222222-2222-2222-2222-222222222222', 'sales2@furnispace.local', {SeedPasswordHash}, 'Minh Sales Two', '0922000002', 'ACTIVE'::account_status, now(), now()),
                ('b0000000-0000-0000-0000-000000000103', '22222222-2222-2222-2222-222222222222', 'sales3@furnispace.local', {SeedPasswordHash}, 'Lan Sales Three', '0922000003', 'ACTIVE'::account_status, now(), now()),
                ('c0000000-0000-0000-0000-000000000101', '33333333-3333-3333-3333-333333333333', 'designer1@furnispace.local', {SeedPasswordHash}, 'Emily Designer One', '0933000001', 'ACTIVE'::account_status, now(), now()),
                ('c0000000-0000-0000-0000-000000000102', '33333333-3333-3333-3333-333333333333', 'designer2@furnispace.local', {SeedPasswordHash}, 'Khoa Designer Two', '0933000002', 'ACTIVE'::account_status, now(), now()),
                ('c0000000-0000-0000-0000-000000000103', '33333333-3333-3333-3333-333333333333', 'designer3@furnispace.local', {SeedPasswordHash}, 'Mai Designer Three', '0933000003', 'ACTIVE'::account_status, now(), now()),
                ('e0000000-0000-0000-0000-000000000101', '55555555-5555-5555-5555-555555555555', 'production1@furnispace.local', {SeedPasswordHash}, 'Phong Production One', '0955000001', 'ACTIVE'::account_status, now(), now()),
                ('e0000000-0000-0000-0000-000000000102', '55555555-5555-5555-5555-555555555555', 'production2@furnispace.local', {SeedPasswordHash}, 'Hanh Production Two', '0955000002', 'ACTIVE'::account_status, now(), now()),
                ('e0000000-0000-0000-0000-000000000103', '55555555-5555-5555-5555-555555555555', 'production3@furnispace.local', {SeedPasswordHash}, 'Bao Production Three', '0955000003', 'ACTIVE'::account_status, now(), now())
    ...
    private static Task<int> SeedFilesAsync(RawSeedExecutor executeRawAsync, CancellationToken cancellationToken)
    {
        return executeRawAsync(
            ...
            VALUES
                ('91000000-0000-0000-0000-000000000001', 'c0000000-0000-0000-0000-000000000101', 'office-measurement.pdf', 'seed-office-measurement.pdf', '/seed/files/office-measurement.pdf', 'seed/measurements/office-measurement.pdf', 'application/pdf', '.pdf', 120000, 'seed-checksum-001', 'ACTIVE'::file_status, now() - INTERVAL '6 days'),
                ('91000000-0000-0000-0000-000000000002', 'c0000000-0000-0000-0000-000000000102', 'premium-cafe-preview.png', 'seed-premium-cafe-preview.png', '/seed/files/premium-cafe-preview.png', 'seed/proposals/premium-cafe-preview.png', 'image/png', '.png', 240000, 'seed-checksum-002', 'ACTIVE'::file_status, now() - INTERVAL '5 days'),
                ('91000000-0000-0000-0000-000000000003', 'b0000000-0000-0000-0000-000000000101', 'showroom-quotation.pdf', 'seed-showroom-quotation.pdf', '/seed/files/showroom-quotation.pdf', 'seed/quotations/showroom-quotation.pdf', 'application/pdf', '.pdf', 180000, 'seed-checksum-003', 'ACTIVE'::file_status, now() - INTERVAL '4 days')
    ...
    private static Task<int> SeedFileLinksAsync(RawSeedExecutor executeRawAsync, CancellationToken cancellationToken)
    {
        return executeRawAsync(
            ...
            VALUES
                ('92000000-0000-0000-0000-000000000001', '91000000-0000-0000-0000-000000000001', 'PROJECT', '40000000-0000-0000-0000-000000000003', 'MEASUREMENT_REPORT'::file_type, 'STAFF_ONLY'::file_visibility, true, 1, 'Measurement file for seed office project.', 'c0000000-0000-0000-0000-000000000101', now() - INTERVAL '6 days'),
                ('92000000-0000-0000-0000-000000000002', '91000000-0000-0000-0000-000000000002', 'PROPOSAL', '50000000-0000-0000-0000-000000000004', 'PROPOSAL_PREVIEW'::file_type, 'CUSTOMER_VISIBLE'::file_visibility, true, 1, 'Preview image for premium cafe proposal.', 'c0000000-0000-0000-0000-000000000102', now() - INTERVAL '5 days'),
                ('92000000-0000-0000-0000-000000000003', '91000000-0000-0000-0000-000000000003', 'QUOTATION', '60000000-0000-0000-0000-000000000005', 'QUOTATION_FILE'::file_type, 'CUSTOMER_VISIBLE'::file_visibility, true, 1, 'Quotation attachment for showroom project.', 'b0000000-0000-0000-0000-000000000101', now() - INTERVAL '4 days')
    ...
    private static Task<int> SeedProjectChatsAsync(RawSeedExecutor executeRawAsync, CancellationToken cancellationToken)
    {
        return executeRawAsync(
            ...
            VALUES
                ('43000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000003', 'SALES'::project_chat_type, 'b0000000-0000-0000-0000-000000000102', 'Sales Consultation', 'OPEN'::project_chat_status, now() - INTERVAL '7 days', null),
                ('43000000-0000-0000-0000-000000000002', '40000000-0000-0000-0000-000000000003', 'DESIGNER'::project_chat_type, 'c0000000-0000-0000-0000-000000000101', 'Design Discussion', 'OPEN'::project_chat_status, now() - INTERVAL '6 days', null),
                ('43000000-0000-0000-0000-000000000003', '40000000-0000-0000-0000-000000000006', 'PRODUCTION'::project_chat_type, 'e0000000-0000-0000-0000-000000000101', 'Production Coordination', 'OPEN'::project_chat_status, now() - INTERVAL '3 days', null)
    ...
    private static Task<int> SeedProjectChatMessagesAsync(RawSeedExecutor executeRawAsync, CancellationToken cancellationToken)
    {
        return executeRawAsync(
            ...
            VALUES
                ('43100000-0000-0000-0000-000000000001', '43000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000102', 'TEXT'::project_chat_message_type, 'We have prepared three office layout options for your review.', null, now() - INTERVAL '6 days', null, null, now() - INTERVAL '6 days'),
                ('43100000-0000-0000-0000-000000000002', '43000000-0000-0000-0000-000000000002', 'c0000000-0000-0000-0000-000000000101', 'FILE'::project_chat_message_type, 'Attached the measurement report for reference.', '91000000-0000-0000-0000-000000000001', now() - INTERVAL '5 days', null, null, null),
                ('43100000-0000-0000-0000-000000000003', '43000000-0000-0000-0000-000000000003', 'e0000000-0000-0000-0000-000000000101', 'TEXT'::project_chat_message_type, 'Production material check is in progress.', null, now() - INTERVAL '2 days', null, null, null)
    ...
    private static Task<int> SeedProposalsAsync(RawSeedExecutor executeRawAsync, CancellationToken cancellationToken)
    {
        return executeRawAsync(
            ...
            VALUES
                ('50000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000003', null, 'Basic Office Layout', 'Lean office setup with core workstations.', 'Functional compact office design.', 1, 310000000.00, 'DRAFT'::proposal_status, 'c0000000-0000-0000-0000-000000000101', null, null, null, now() - INTERVAL '6 days', now() - INTERVAL '6 days'),
                ('50000000-0000-0000-0000-000000000002', '40000000-0000-0000-0000-000000000003', null, 'Standard Office Layout', 'Balanced design with meeting and storage areas.', 'Warm productive workspace.', 2, 420000000.00, 'PUBLISHED'::proposal_status, 'c0000000-0000-0000-0000-000000000101', now() - INTERVAL '4 days', null, null, now() - INTERVAL '5 days', now() - INTERVAL '4 days'),
                ('50000000-0000-0000-0000-000000000003', '40000000-0000-0000-0000-000000000003', null, 'Premium Office Layout', 'Premium version with reception and acoustic partitions.', 'Modern executive workspace.', 3, 510000000.00, 'PUBLISHED'::proposal_status, 'c0000000-0000-0000-0000-000000000101', now() - INTERVAL '3 days', null, null, now() - INTERVAL '4 days', now() - INTERVAL '3 days'),
                ('50000000-0000-0000-0000-000000000004', '40000000-0000-0000-0000-000000000004', null, 'Premium Cafe Layout', 'Selected premium cafe layout.', 'Warm minimal flagship cafe.', 1, 620000000.00, 'SELECTED'::proposal_status, 'c0000000-0000-0000-0000-000000000102', now() - INTERVAL '6 days', now() - INTERVAL '2 days', null, now() - INTERVAL '7 days', now() - INTERVAL '2 days'),
    ...
    private static Task<int> SeedProposalScenesAsync(RawSeedExecutor executeRawAsync, CancellationToken cancellationToken)
    {
        return executeRawAsync(
            ...
            VALUES
                ('51000000-0000-0000-0000-000000000001', '50000000-0000-0000-0000-000000000002', '41000000-0000-0000-0000-000000000001', 'Standard Office 3D Scene', 'THREE_D'::proposal_scene_type, 'mongo-seed-office-standard', null, 1, true, 'c0000000-0000-0000-0000-000000000101', now() - INTERVAL '4 days', now() - INTERVAL '4 days'),
                ('51000000-0000-0000-0000-000000000002', '50000000-0000-0000-0000-000000000004', '41000000-0000-0000-0000-000000000002', 'Premium Cafe 3D Scene', 'THREE_D'::proposal_scene_type, 'mongo-seed-cafe-premium', '91000000-0000-0000-0000-000000000002', 1, true, 'c0000000-0000-0000-0000-000000000102', now() - INTERVAL '5 days', now() - INTERVAL '3 days'),
                ('51000000-0000-0000-0000-000000000003', '50000000-0000-0000-0000-000000000006', '41000000-0000-0000-0000-000000000003', 'Showroom Main Hall Scene', 'THREE_D'::proposal_scene_type, 'mongo-seed-showroom-main', null, 1, true, 'c0000000-0000-0000-0000-000000000103', now() - INTERVAL '19 days', now() - INTERVAL '18 days')
    ...
    private static Task<int> SeedProposalSceneVariantsAsync(RawSeedExecutor executeRawAsync, CancellationToken cancellationToken)
    {
        return executeRawAsync(
            ...
            VALUES
                ('53000000-0000-0000-0000-000000000001', '50000000-0000-0000-0000-000000000002', '51000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000103', 'CUSTOMER_SUGGESTION'::proposal_scene_variant_type, 'SUBMITTED'::proposal_scene_variant_status, 'mongo-seed-office-variant-001', 'Move meeting table closer to window.', now() - INTERVAL '3 days', null, null, null, null, null, now() - INTERVAL '3 days', now() - INTERVAL '3 days'),
                ('53000000-0000-0000-0000-000000000002', '50000000-0000-0000-0000-000000000004', '51000000-0000-0000-0000-000000000002', 'dddddddd-dddd-dddd-dddd-dddddddddddd', 'CUSTOMER_SUGGESTION'::proposal_scene_variant_type, 'ACCEPTED'::proposal_scene_variant_status, 'mongo-seed-cafe-variant-001', 'Use darker walnut tone for counter.', now() - INTERVAL '4 days', 'c0000000-0000-0000-0000-000000000102', now() - INTERVAL '3 days', 'Accepted material tone change.', now() - INTERVAL '3 days', 'c0000000-0000-0000-0000-000000000102', now() - INTERVAL '4 days', now() - INTERVAL '3 days'),
                ('53000000-0000-0000-0000-000000000003', '50000000-0000-0000-0000-000000000006', '51000000-0000-0000-0000-000000000003', 'c0000000-0000-0000-0000-000000000103', 'DESIGNER_REVISION'::proposal_scene_variant_type, 'APPLIED'::proposal_scene_variant_status, 'mongo-seed-showroom-variant-001', 'Applied wider walking path near display island.', now() - INTERVAL '17 days', 'b0000000-0000-0000-0000-000000000101', now() - INTERVAL '16 days', 'Looks good for production.', now() - INTERVAL '16 days', 'c0000000-0000-0000-0000-000000000103', now() - INTERVAL '17 days', now() - INTERVAL '16 days')
    ...
    private static Task<int> SeedCustomizationRequestsAsync(RawSeedExecutor executeRawAsync, CancellationToken cancellationToken)
    {
        return executeRawAsync(
            ...
            INSERT INTO customization_requests (
                ...
                additional_cost_reason, material_available, production_risk_note, sales_review_by,
                approved_product_version_id, status, customer_accepted_at, customer_rejected_at, created_at, updated_at
            )
            VALUES
                ('54000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000003', '50000000-0000-0000-0000-000000000002', '52000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000103', 'Desk cable grommet update', 'Add cable grommets to every work desk.', null, null, null, null, null, 'Need cleaner cable routing.', 'c0000000-0000-0000-0000-000000000101', 'Add two grommets per desk.', null, null, null, null, null, null, null, 'b0000000-0000-0000-0000-000000000102', null, 'DESIGN_REVIEWING'::customization_status, null, null, now() - INTERVAL '3 days', now() - INTERVAL '2 days'),
                ('54000000-0000-0000-0000-000000000002', '40000000-0000-0000-0000-000000000004', '50000000-0000-0000-0000-000000000004', '52000000-0000-0000-0000-000000000002', 'dddddddd-dddd-dddd-dddd-dddddddddddd', 'Dark walnut counter finish', 'Change service counter color to dark walnut.', 380.00, 220.00, 70.00, 'Plywood with walnut veneer', 'Dark Walnut', 'Match premium cafe brand tone.', 'c0000000-0000-0000-0000-000000000102', 'Designer approved revised finish.', 'e0000000-0000-0000-0000-000000000101', 'Feasible with available veneer.', 7, 10000000.00, 'Additional veneer and finishing labor.', true, 'Low risk.', 'b0000000-0000-0000-0000-000000000103', null, 'WAITING_FOR_CUSTOMER_FINAL_APPROVAL'::customization_status, null, null, now() - INTERVAL '4 days', now() - INTERVAL '1 day'),
                ('54000000-0000-0000-0000-000000000003', '40000000-0000-0000-0000-000000000006', '50000000-0000-0000-0000-000000000006', '52000000-0000-0000-0000-000000000003', 'a0000000-0000-0000-0000-000000000102', 'Premium sofa fabric upgrade', 'Upgrade showroom sofa fabric to stain-resistant linen.', null, null, null, 'Stain-resistant linen', 'Warm Gray', 'Need durable fabric for heavy showroom use.', 'c0000000-0000-0000-0000-000000000103', 'Approved for production review.', 'e0000000-0000-0000-0000-000000000102', 'Feasible but needs supplier confirmation.', 10, 6000000.00, 'Premium fabric surcharge.', true, 'Supplier lead time may vary.', 'b0000000-0000-0000-0000-000000000101', null, 'ACCEPTED'::customization_status, now() - INTERVAL '10 days', null, now() - INTERVAL '15 days', now() - INTERVAL '10 days')
    ...
    private static Task<int> SeedQuotationsAsync(RawSeedExecutor executeRawAsync, CancellationToken cancellationToken)
    {
        return executeRawAsync(
            ...
            VALUES
                ('60000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000004', '50000000-0000-0000-0000-000000000004', 'QTN-SEED-0001', 1, 620000000.00, 0.00, 0.00, 620000000.00, 'DRAFT'::quotation_status, DATE '2026-12-31', null, 'Draft quotation for selected cafe proposal.', null, null, 'b0000000-0000-0000-0000-000000000103', null, null, null, now() - INTERVAL '2 days', now() - INTERVAL '2 days'),
                ('60000000-0000-0000-0000-000000000002', '40000000-0000-0000-0000-000000000003', '50000000-0000-0000-0000-000000000002', 'QTN-SEED-0002', 1, 420000000.00, 5000000.00, 0.00, 415000000.00, 'SENT'::quotation_status, DATE '2026-12-20', 'Please review the office quotation.', 'Sent to customer for office project.', null, null, 'b0000000-0000-0000-0000-000000000102', now() - INTERVAL '1 day', null, null, now() - INTERVAL '2 days', now() - INTERVAL '1 day'),
    ...
    private static Task<int> SeedOrdersAsync(RawSeedExecutor executeRawAsync, CancellationToken cancellationToken)
    {
        return executeRawAsync(
            ...
            VALUES
                ('70000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000005', '50000000-0000-0000-0000-000000000005', '60000000-0000-0000-0000-000000000003', 'ORD-SEED-0001', 'a0000000-0000-0000-0000-000000000101', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 760000000.00, 0.00, 0.00, 760000000.00, 228000000.00, 0.00, 760000000.00, 'DEPOSIT_PENDING'::order_status, 'Binh Thanh District, Ho Chi Minh City', 'Nguyen Cafe Owner', '0911000001', 'Deliver after site floor completion.', null, 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', now() - INTERVAL '7 days', now() - INTERVAL '7 days', now() - INTERVAL '7 days'),
                ('70000000-0000-0000-0000-000000000002', '40000000-0000-0000-0000-000000000006', '50000000-0000-0000-0000-000000000006', '60000000-0000-0000-0000-000000000004', 'ORD-SEED-0002', 'a0000000-0000-0000-0000-000000000102', 'b0000000-0000-0000-0000-000000000101', 1050000000.00, 0.00, 0.00, 1050000000.00, 315000000.00, 315000000.00, 735000000.00, 'DEPOSIT_PAID'::order_status, 'Tan Binh District, Ho Chi Minh City', 'Tran Fashion Owner', '0911000002', 'Coordinate delivery by display zones.', null, 'b0000000-0000-0000-0000-000000000101', now() - INTERVAL '17 days', now() - INTERVAL '17 days', now() - INTERVAL '1 day'),
                ('70000000-0000-0000-0000-000000000003', '40000000-0000-0000-0000-000000000007', '50000000-0000-0000-0000-000000000007', '60000000-0000-0000-0000-000000000005', 'ORD-SEED-0003', 'a0000000-0000-0000-0000-000000000103', 'b0000000-0000-0000-0000-000000000102', 290000000.00, 0.00, 0.00, 290000000.00, 87000000.00, 290000000.00, 0.00, 'IN_PRODUCTION'::order_status, 'District 5, Ho Chi Minh City', 'Le Office Manager', '0911000003', 'Completed seed order kept for history.', 'All delivered items confirmed.', 'b0000000-0000-0000-0000-000000000102', now() - INTERVAL '27 days', now() - INTERVAL '27 days', now() - INTERVAL '1 day')
    ...
    private static Task<int> SeedPaymentsAsync(RawSeedExecutor executeRawAsync, CancellationToken cancellationToken)
    {
        return executeRawAsync(
            ...
            INSERT INTO payments (
                ...
                payment_type, amount, paid_amount, remaining_amount, currency, status,
                expired_at, paid_at, cancelled_at, note, created_at, updated_at
            )
            VALUES
                ('80000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000003', null, '60000000-0000-0000-0000-000000000002', 'PAY-SEED-0001', 'a0000000-0000-0000-0000-000000000103', 'PROJECT_START_FEE'::payment_type, 5000000.00, 5000000.00, 0.00, 'VND', 'PAID'::payment_status, null, now() - INTERVAL '2 days', null, 'Paid project start fee.', now() - INTERVAL '3 days', now() - INTERVAL '2 days'),
                ('80000000-0000-0000-0000-000000000002', '40000000-0000-0000-0000-000000000005', '70000000-0000-0000-0000-000000000001', '60000000-0000-0000-0000-000000000003', 'PAY-SEED-0002', 'a0000000-0000-0000-0000-000000000101', 'DEPOSIT'::payment_type, 228000000.00, 80000000.00, 148000000.00, 'VND', 'PARTIALLY_PAID'::payment_status, now() + INTERVAL '7 days', null, null, 'Partial deposit received for restaurant order.', now() - INTERVAL '6 days', now() - INTERVAL '1 day'),
                ('80000000-0000-0000-0000-000000000003', '40000000-0000-0000-0000-000000000006', '70000000-0000-0000-0000-000000000002', '60000000-0000-0000-0000-000000000004', 'PAY-SEED-0003', 'a0000000-0000-0000-0000-000000000102', 'DEPOSIT'::payment_type, 315000000.00, 315000000.00, 0.00, 'VND', 'PAID'::payment_status, null, now() - INTERVAL '15 days', null, 'Deposit paid for showroom order.', now() - INTERVAL '16 days', now() - INTERVAL '15 days')
    ...
    private static Task<int> SeedPaymentTransactionsAsync(RawSeedExecutor executeRawAsync, CancellationToken cancellationToken)
    {
        return executeRawAsync(
            ...
            INSERT INTO payment_transactions (
                ...
                provider_transaction_id, provider_reference_code, status, transaction_time,
                confirmed_by, confirmed_at, failure_reason, raw_provider_payload, created_at
            )
            VALUES
                ('81000000-0000-0000-0000-000000000001', '80000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000003', null, 'TXN-SEED-0001', 'CHARGE'::payment_transaction_type, 5000000.00, 'VND', 'MANUAL_BANK_TRANSFER'::payment_provider, 'BANK_TRANSFER'::payment_method, 'BANK-SEED-0001', 'PAY-SEED-0001', 'SUCCESS'::payment_transaction_status, now() - INTERVAL '2 days', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', now() - INTERVAL '2 days', null, '{"seed": true, "channel": "manual"}'::jsonb, now() - INTERVAL '2 days'),
                ('81000000-0000-0000-0000-000000000002', '80000000-0000-0000-0000-000000000002', '40000000-0000-0000-0000-000000000005', '70000000-0000-0000-0000-000000000001', 'TXN-SEED-0002', 'CHARGE'::payment_transaction_type, 80000000.00, 'VND', 'PAYOS'::payment_provider, 'QR_CODE'::payment_method, 'PAYOS-SEED-0002', 'PAY-SEED-0002', 'SUCCESS'::payment_transaction_status, now() - INTERVAL '1 day', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', now() - INTERVAL '1 day', null, '{"seed": true, "channel": "payos"}'::jsonb, now() - INTERVAL '1 day'),
                ('81000000-0000-0000-0000-000000000003', '80000000-0000-0000-0000-000000000003', '40000000-0000-0000-0000-000000000006', '70000000-0000-0000-0000-000000000002', 'TXN-SEED-0003', 'CHARGE'::payment_transaction_type, 315000000.00, 'VND', 'SEPAY'::payment_provider, 'BANK_TRANSFER'::payment_method, 'SEPAY-SEED-0003', 'PAY-SEED-0003', 'SUCCESS'::payment_transaction_status, now() - INTERVAL '15 days', 'b0000000-0000-0000-0000-000000000101', now() - INTERVAL '15 days', null, '{"seed": true, "channel": "sepay"}'::jsonb, now() - INTERVAL '15 days')
    ...
    private static Task<int> SeedProductionRequestsAsync(RawSeedExecutor executeRawAsync, CancellationToken cancellationToken)
    {
        return executeRawAsync(
            ...
            VALUES
                ('82000000-0000-0000-0000-000000000001', 'PROD-SEED-0001', '40000000-0000-0000-0000-000000000005', '70000000-0000-0000-0000-000000000001', 'e0000000-0000-0000-0000-000000000101', 'PENDING_REVIEW'::production_request_status, 'NORMAL', DATE '2026-08-01', DATE '2026-08-25', null, null, 'Pending deposit confirmation.', now() - INTERVAL '6 days', now() - INTERVAL '6 days'),
                ('82000000-0000-0000-0000-000000000002', 'PROD-SEED-0002', '40000000-0000-0000-0000-000000000006', '70000000-0000-0000-0000-000000000002', 'e0000000-0000-0000-0000-000000000102', 'IN_PRODUCTION'::production_request_status, 'HIGH', DATE '2026-07-20', DATE '2026-08-20', DATE '2026-07-21', null, 'Showroom display production started.', now() - INTERVAL '14 days', now() - INTERVAL '1 day'),
                ('82000000-0000-0000-0000-000000000003', 'PROD-SEED-0003', '40000000-0000-0000-0000-000000000007', '70000000-0000-0000-0000-000000000003', 'e0000000-0000-0000-0000-000000000103', 'COMPLETED'::production_request_status, 'NORMAL', DATE '2026-06-10', DATE '2026-06-25', DATE '2026-06-11', DATE '2026-06-24', 'Completed office order production.', now() - INTERVAL '25 days', now() - INTERVAL '2 days')
    ...
    private static Task<int> SeedNotificationsAsync(RawSeedExecutor executeRawAsync, CancellationToken cancellationToken)
    {
        return executeRawAsync(
            ...
            VALUES
                ('90000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000103', '40000000-0000-0000-0000-000000000003', 'Proposal published', 'A new proposal has been published for your office project.', 'ProposalPublished', 'PROPOSAL', '50000000-0000-0000-0000-000000000002', false, null, null, now() - INTERVAL '4 days'),
                ('90000000-0000-0000-0000-000000000002', 'c0000000-0000-0000-0000-000000000102', '40000000-0000-0000-0000-000000000004', 'Designer assigned', 'You have been assigned as Designer for the premium cafe project.', 'ProjectDesignerAssigned', 'PROJECT', '40000000-0000-0000-0000-000000000004', true, now() - INTERVAL '8 days', null, now() - INTERVAL '9 days'),
                ('90000000-0000-0000-0000-000000000003', 'e0000000-0000-0000-0000-000000000101', '40000000-0000-0000-0000-000000000004', 'Customization review required', 'A customization request needs production review.', 'CustomizationProductionReviewRequested', 'CUSTOMIZATION_REQUEST', '54000000-0000-0000-0000-000000000002', false, null, null, now() - INTERVAL '2 days')
    ...
    private static Task<int> SeedProjectReviewsAsync(RawSeedExecutor executeRawAsync, CancellationToken cancellationToken)
    {
        return executeRawAsync(
            ...
            VALUES
                ('94000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000005', '70000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000101', 4, 4, 5, 4, 'Seed restaurant workflow review placeholder.', now() - INTERVAL '1 day', now() - INTERVAL '1 day'),
                ('94000000-0000-0000-0000-000000000002', '40000000-0000-0000-0000-000000000006', '70000000-0000-0000-0000-000000000002', 'a0000000-0000-0000-0000-000000000102', 5, 5, 4, 5, 'Showroom production is progressing well.', now() - INTERVAL '1 day', now() - INTERVAL '1 day'),
                ('94000000-0000-0000-0000-000000000003', '40000000-0000-0000-0000-000000000007', '70000000-0000-0000-0000-000000000003', 'a0000000-0000-0000-0000-000000000103', 5, 5, 5, 5, 'Completed office installation met expectations.', now() - INTERVAL '1 day', now() - INTERVAL '1 day')
