...
public static class DataSeeder
{
    ...
    private static Task SeedProductsAsync(AppDbContext dbContext, CancellationToken cancellationToken)
    {
        return dbContext.Database.ExecuteSqlRawAsync(
            """
            INSERT INTO products (product_id, category_id, product_code, product_name, description, status, created_by, created_at, updated_at)
            VALUES
                ('20000000-0000-0000-0000-000000000001', '10000000-0000-0000-0000-000000000001', 'SOFA-LUX-001', 'Luxe Modular Sofa', 'Custom modular sofa for living spaces', 'ACTIVE'::product_status, 'cccccccc-cccc-cccc-cccc-cccccccccccc', now(), now()),
                ('20000000-0000-0000-0000-000000000002', '10000000-0000-0000-0000-000000000002', 'WARD-STD-001', 'Sliding Door Wardrobe', 'Built-in wardrobe with sliding doors', 'ACTIVE'::product_status, 'cccccccc-cccc-cccc-cccc-cccccccccccc', now(), now()),
                ('20000000-0000-0000-0000-000000000003', '10000000-0000-0000-0000-000000000003', 'KITCH-CAB-001', 'Modern Kitchen Cabinet', 'Upper and lower kitchen cabinet set', 'ACTIVE'::product_status, 'cccccccc-cccc-cccc-cccc-cccccccccccc', now(), now()),
                ('20000000-0000-0000-0000-000000000004', '10000000-0000-0000-0000-000000000004', 'DESK-OAK-001', 'Oak Work Desk', 'Minimal office desk with drawer module', 'ACTIVE'::product_status, 'cccccccc-cccc-cccc-cccc-cccccccccccc', now(), now())
    ...
    private static Task SeedProductVersionsAsync(AppDbContext dbContext, CancellationToken cancellationToken)
    {
        return dbContext.Database.ExecuteSqlRawAsync(
            ...
            INSERT INTO product_versions (
                ...
                material, color, finish, width, height, depth, estimated_price,
                is_default, is_public, is_project_specific, status, created_by, created_at, updated_at
            )
            VALUES
                ('30000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000001', 'SOFA-LUX-001-A', 'Luxe Modular Sofa - Linen', 'STANDARD'::product_version_type, 'Solid wood frame, linen upholstery', 'Warm Gray', 'Matte fabric', 280.00, 82.00, 95.00, 18500000.00, true, true, false, 'ACTIVE'::product_version_status, 'cccccccc-cccc-cccc-cccc-cccccccccccc', now(), now()),
                ('30000000-0000-0000-0000-000000000002', '20000000-0000-0000-0000-000000000002', 'WARD-STD-001-A', 'Sliding Door Wardrobe - White Oak', 'STANDARD'::product_version_type, 'MDF, laminate', 'White Oak', 'Laminate', 240.00, 260.00, 60.00, 22500000.00, true, true, false, 'ACTIVE'::product_version_status, 'cccccccc-cccc-cccc-cccc-cccccccccccc', now(), now()),
                ('30000000-0000-0000-0000-000000000003', '20000000-0000-0000-0000-000000000003', 'KITCH-CAB-001-A', 'Modern Kitchen Cabinet - Gloss White', 'STANDARD'::product_version_type, 'Plywood, acrylic surface', 'Gloss White', 'High gloss', 360.00, 220.00, 65.00, 42000000.00, true, true, false, 'ACTIVE'::product_version_status, 'cccccccc-cccc-cccc-cccc-cccccccccccc', now(), now()),
                ('30000000-0000-0000-0000-000000000004', '20000000-0000-0000-0000-000000000004', 'DESK-OAK-001-A', 'Oak Work Desk - Natural', 'STANDARD'::product_version_type, 'Oak veneer, powder-coated steel', 'Natural Oak', 'Clear matte coat', 160.00, 75.00, 70.00, 8900000.00, true, true, false, 'ACTIVE'::product_version_status, 'cccccccc-cccc-cccc-cccc-cccccccccccc', now(), now())
