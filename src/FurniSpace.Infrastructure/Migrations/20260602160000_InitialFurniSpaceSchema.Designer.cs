...
namespace FurniSpace.Infrastructure.Migrations
{
    ...
    [Migration("20260602160000_InitialFurniSpaceSchema")]
    partial class InitialFurniSpaceSchema
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "customization_feasibility_status", new[] { "PENDING", "FEASIBLE", "NOT_FEASIBLE", "NEED_REVISION" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "customization_status", new[] { "SUBMITTED", "DESIGN_REVIEWING", "PRODUCTION_REVIEWING", "WAITING_FOR_CUSTOMER_APPROVAL", "ACCEPTED", "REJECTED_BY_CUSTOMER", "NOT_FEASIBLE", "CANCELLED", "CONVERTED_TO_VERSION" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "delivery_item_status", new[] { "PENDING", "LOADED", "DELIVERED", "FAILED", "CANCELLED" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "delivery_status", new[] { "PENDING_SCHEDULE", "SCHEDULED", "DELIVERING", "DELIVERED", "FAILED", "RESCHEDULED", "CANCELLED" });
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "file_visibility", new[] { "CUSTOMER_VISIBLE", "INTERNAL", "STAFF_ONLY", "PRIVATE" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "measurement_appointment_status", new[] { "PENDING_CONFIRMATION", "CONFIRMED", "RESCHEDULED", "COMPLETED", "CANCELLED", "NO_SHOW" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "notification_status", new[] { "UNREAD", "READ" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "order_status", new[] { "CREATED", "CONFIRMED", "PENDING_PAYMENT", "IN_PRODUCTION", "READY_FOR_DELIVERY", "DELIVERING", "DELIVERED", "COMPLETED", "CANCELLED" });
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "product_version_status", new[] { "ACTIVE", "INACTIVE", "ARCHIVED" });
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "project_assignment_role", new[] { "SALES_CONSULTANT", "DESIGNER_STAFF", "PRODUCTION_STAFF", "DELIVERY_STAFF", "ADMIN_SUPPORT" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "project_assignment_status", new[] { "ACTIVE", "INACTIVE", "REASSIGNED", "CANCELLED" });
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "project_status", new[] { "DRAFT", "SUBMITTED", "SALES_ASSIGNED", "IN_CONSULTATION", "NEED_BASIC_INFORMATION", "WAITING_FOR_DESIGNER_ASSIGNMENT", "SPACE_INPUT_REVIEW", "MEASUREMENT_REQUIRED", "WAITING_FOR_SCHEDULE_CONFIRMATION", "MEASUREMENT_SCHEDULED", "MEASUREMENT_COMPLETED", "SPACE_VERIFICATION_REQUIRED", "SPACE_VERIFIED", "LAYOUT_DESIGNING", "PROPOSAL_DRAFTING", "WAITING_FOR_CUSTOMER_REVIEW", "REVISION_REQUESTED", "PROPOSAL_SELECTED", "QUOTATION_PREPARING", "QUOTATION_SENT", "QUOTATION_REVISION_REQUESTED", "QUOTATION_ACCEPTED", "ORDER_CONFIRMED", "IN_PRODUCTION", "PRODUCTION_BLOCKED", "READY_FOR_DELIVERY", "DELIVERY_SCHEDULED", "DELIVERING", "DELIVERED", "COMPLETED", "REJECTED", "CANCELLED" });
            ...
            modelBuilder.Entity("FurniSpace.Domain.Entities.CustomizationRequest", b =>
                {
                    ...
                    b.Property<string>("FeasibilityStatus")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("customization_feasibility_status")
                    ...
                    b.Property<string>("RequestedFinish")
                        .HasColumnType("varchar(100)")
                        .HasColumnName("requested_finish");
            ...
            modelBuilder.Entity("FurniSpace.Domain.Entities.Delivery", b =>
                {
                    ...
                    b.Property<Guid?>("AssignedDeliveryStaffId")
                        .HasColumnType("uuid")
                        .HasColumnName("assigned_delivery_staff_id");
                    ...
                    b.Property<string>("Status")
                        ...
                        .HasDefaultValue("PENDING_SCHEDULE")
                        .HasColumnName("status");
            ...
            modelBuilder.Entity("FurniSpace.Domain.Entities.DeliveryItem", b =>
                {
                    ...
                    b.Property<string>("Status")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("delivery_item_status")
                        .HasDefaultValue("PENDING")
                        .HasColumnName("status");
            ...
            modelBuilder.Entity("FurniSpace.Domain.Entities.MeasurementAppointment", b =>
                {
                    ...
                    b.Property<Guid?>("ScheduledBySalesId")
                        .HasColumnType("uuid")
                        .HasColumnName("scheduled_by_sales_id");

                    b.Property<string>("Status")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("measurement_appointment_status")
                    ...
                    b.HasIndex("ScheduledBySalesId");

                    b.ToTable("measurement_appointments", (string)null);
                });
            ...
            modelBuilder.Entity("FurniSpace.Domain.Entities.ProductVersion", b =>
                {
                    ...
                    b.Property<string>("Status")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("product_version_status")
                        .HasDefaultValue("ACTIVE")
                        .HasColumnName("status");
            ...
            modelBuilder.Entity("FurniSpace.Domain.Entities.ProjectAssignment", b =>
                {
                    ...
                    b.Property<string>("AssignmentRole")
                        .IsRequired()
                        .HasColumnType("project_assignment_role")
                    ...
                    b.Property<string>("Status")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("project_assignment_status")
                        .HasDefaultValue("ACTIVE")
                        .HasColumnName("status");
            ...
            modelBuilder.Entity("FurniSpace.Domain.Entities.MeasurementAppointment", b =>
                {
                    ...
                    b.HasOne("FurniSpace.Domain.Entities.Account", null)
                        .WithMany()
                        .HasForeignKey("ScheduledBySalesId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
