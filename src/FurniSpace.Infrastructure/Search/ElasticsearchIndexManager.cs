...
public sealed class ElasticsearchIndexManager : IIndexManager
{
    private const string AccountsMappingResourceName =
        "FurniSpace.Infrastructure.Search.Mappings.accounts-index.json";

    private const string ProductsMappingResourceName =
        "FurniSpace.Infrastructure.Search.Mappings.products-index.json";

    private const string ProjectsMappingResourceName =
        "FurniSpace.Infrastructure.Search.Mappings.projects-index.json";

    private const string ChatMessagesMappingResourceName =
        "FurniSpace.Infrastructure.Search.Mappings.chat-messages-index.json";

    private const string ProjectFilesMappingResourceName =
        "FurniSpace.Infrastructure.Search.Mappings.project-files-index.json";
