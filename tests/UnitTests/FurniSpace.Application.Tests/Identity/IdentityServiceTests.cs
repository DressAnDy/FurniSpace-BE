...
public sealed class IdentityServiceTests
{
    ...
    private sealed class FakeIdentityAccountRepository : IAccountRepository
    {
        ...
        public Task<IReadOnlyList<Infrastructure.ReadModels.Accounts.SalesWorkloadItemReadModel>> GetSalesWorkloadAsync(Infrastructure.ReadModels.Accounts.SalesWorkloadListQuery query, CancellationToken cancellationToken = default) => Task.FromResult<IReadOnlyList<Infrastructure.ReadModels.Accounts.SalesWorkloadItemReadModel>>([]);
