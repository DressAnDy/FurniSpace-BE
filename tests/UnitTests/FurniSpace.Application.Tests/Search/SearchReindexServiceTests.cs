...
public sealed class SearchReindexServiceTests
{
    ...
    private sealed class FakeAccountRepository : IAccountRepository
    {
        ...
        public Task<IReadOnlyList<SalesWorkloadItemReadModel>> GetSalesWorkloadAsync(int page, int pageSize, int maxActiveProjects, string? search, string? capacityState, string? futurePressureState, string sortBy, CancellationToken cancellationToken = default) => Task.FromResult<IReadOnlyList<SalesWorkloadItemReadModel>>([]);
